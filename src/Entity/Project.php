...
class Project
{
    ...
    public function getFincancialDetails(): ?string
    {
        return $this->fincancial_details;
    }

    public function setFincancialDetails(?string $fincancial_details): self
    {
        $this->fincancial_details = $fincancial_details;
